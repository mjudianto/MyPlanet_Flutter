                                  ...
                                  children: <Widget>[
                                    ...
                                    Obx( () {
                                      return InputWithTitle(
                                        ...
                                        suffixIcon:  IconButton(
                                          icon: Icon(
                                            profilePageController.isConfirmNewPasswordHidden.value ? Icons.visibility_off : Icons.visibility_outlined,
                                            color: primaryColor,
                                          ),
                                          onPressed: () {
                                      ...
                                      child: Column(
                                        children: [
                                          Container(
                                            ...
                                            child: TextButton(
                                              onPressed: () {
                                                if (profilePageController.newPasswordController.text == profilePageController.confirmNewPasswordController.text){
                                                  profilePageController.changePassword(profilePageController.oldPasswordController.text, profilePageController.newPasswordController.text);
                                                  Get.back();

                                                  Get.defaultDialog(
                                                    title: profilePageController.passwordChangedSuccessfully ? 'SUCCESS' : 'FAILED',
                                                    titlePadding: const EdgeInsets.all(20.0),
                                                    middleText: profilePageController.passwordChangedSuccessfully ? 'Password change SUCCESS' : 'Password change FAILED',
                                                  );
                                                } else {
                                                  Get.defaultDialog(
                                                    title: 'FAILED',
